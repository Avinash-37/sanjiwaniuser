...
class ViewCurrentOrder extends Component {
    constructor(props) {
        super(props);
        this.state={
            cartList:[],
    ...
    render() {
        ...
        return (
            <div className="cart">
                <ProductBar productTitle={"View Current Order"}backUrl={"admin"}search={false}like={false}cart={false}/> 
...
export default ViewCurrentOrder;